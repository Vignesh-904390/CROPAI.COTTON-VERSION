...
# === Flask Setup ===
app = Flask(__name__)
app.secret_key = 'cotton_secret_key_123'  # Change this for production

UPLOAD_FOLDER = 'static/uploads'
MODEL_PATH = 'model/cotton_effnet.pth'
DISEASE_JSON_PATH = 'disease_info_cotton.json'  # JSON with disease info
...
app.config['MAIL_PASSWORD'] = 'rtwt opco zptt jwvz'  # Replace with app password
mail = Mail(app)
